        ...
        <div className="modal-overlay">
            <div className="modal-content">
                ...
                <div className="form-section">
                    ...
                    <textarea name="dimensions" placeholder="Dimensions" required value={productData.dimensions} onChange={handleChange} style={{width:'93%'}}/>
...
const AddProduct = (categories) => {
  ...
  const handleEditorChange = (value, name) => {
    ...
    const handleSave = async () => {    
        ...
        if (!productData.product_obj.model || !productData.product_obj.brand_id || !productData.product_obj.product_name || !productData.product_obj.long_description ) {            
        ...
        try {
            ...
            if (response.data?.data?.status === true) {
                ...
                setProductData({
                    product_obj: { model: '', mpn: '', upc_ean: '', breadcrumb: '', brand_id: '', product_name: '',dimensions:'', height:'', width:'', depth:'', length:'', units:'in', long_description: '', short_description: '', features: '', attributes: '', tags: '', msrp: '', base_price: '', key_features: '',features_notes:'', option_str:'', image: [''], varients: [{
                            sku_number: '',
                            finished_price: '0',
                            un_finished_price: '0',
                            quantity: '0',
